...
<div class="daily-deals">
  <div class="container position-relative">
    ...
    <div class="position-relative">
      <!-- Scrollable row -->
      <div class="d-flex overflow-x-auto hide-scrollbar gap-3" id="dealCarousel" style="scroll-snap-type: x mandatory;">
        <!-- 12 product cards -->
...
<div class="py-5 bg-white">
  <div class="container position-relative">
    ...
    <div class="position-relative">
      <div class="d-flex overflow-x-auto hide-scrollbar gap-3" id="bestsellersCarousel" style="scroll-snap-type: x mandatory;">
...
<div class="daily-deals">
  <div class="container position-relative">
    ...
    <div class="position-relative">
      <div class="d-flex overflow-x-auto hide-scrollbar gap-3" id="categoriesCarousel" style="scroll-snap-type: x mandatory;">
...
<div class="py-5 bg-white">
  <div class="container position-relative">
    ...
    <div class="position-relative">
      <div class="d-flex overflow-x-auto hide-scrollbar gap-3" id="tiktokCarousel" style="scroll-snap-type: x mandatory;">
        <div class="deal-product flex-shrink-0 text-center" style="width: 230px; scroll-snap-align: start;">
